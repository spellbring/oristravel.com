...
Usuarios.prototype.procesoEnviaForm = function(classFrm,url,btn,urlCarga){
...
Usuarios.prototype.abrePopupCenter = function(docPHP, titulo, cod){
    $("#ML_divPopup").html('');
  ...
  Usuarios.prototype.abreEliminarUser = function(docPHP, titulo, cod, urlCarga)
{
    $("#ML_divPopup").html('');
    $("#ML_tituloForm").html(titulo);
    $.post(docPHP, 
